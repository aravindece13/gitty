<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/Popups.master" AutoEventWireup="false" CodeFile="ActionAddVendorComment.aspx.vb" Inherits="Exec_ActionAddVendorComment" %>
...
//                GetRadWindow().BrowserWindow.refreshGrid(args);
    ...
    <div id="divFormView" style="padding: 5px 2px 5px 5px;">
        <h6>Add Vendor Comment for <asp:Label ID="lblVendor" runat="server"></asp:Label></h6>
        
          <asp:HiddenField ID="Type" runat="server" Value="Vendor" />

<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/InsideSales.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="InsideSales_Default" %>
...
<div id="News" style="padding:0px 2px 2px 5px;float:left;height:90%;width:96%;">
    ...
    <telerik:RadListView ID="RadListView1" runat="server"  
            AllowPaging="false" DataSourceID="SqlDataSourceNews" width="90%" Height="90%">
     ...
     <asp:SqlDataSource ID="SqlDataSourceNews" runat="server" 
         ...
         AND TopicArea IN ('Sales','Purchasing','AMR','Fleet','Payroll','Credit','Warehouse')

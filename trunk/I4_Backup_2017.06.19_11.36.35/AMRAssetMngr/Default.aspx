<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/AMRAssetMngr.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="AMRAssetMngr_Default" %>
            ...
            <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="ID" DataKeyNames="ID" DataSourceID="SqlDS_AssetList" 
                ...
                <Columns>
                    <telerik:GridTemplateColumn 
                            ...
                            <ItemTemplate>
                                <a href="#" onclick="openRadCheckOutWindow('<%# DataBinder.Eval(Container.DataItem, "ID") %>'); return false;">CheckOut</a>
                            </ItemTemplate>
                    <HeaderStyle Width="55px" Font-Size="XX-Small" />
                    <ItemStyle Width="55px" Font-Size="XX-Small" />
                    </telerik:GridTemplateColumn>
                    ...
                    <HeaderStyle Width="45px" Font-Size="XX-Small" />
                    <ItemStyle Width="45px" Font-Size="XX-Small"/>
                    </telerik:GridTemplateColumn>
                    ...
                    <HeaderStyle Width="50px" Font-Size="XX-Small"/>
                    <ItemStyle Width="50px" Font-Size="XX-Small"/>
                    </telerik:GridTemplateColumn>
                    ...
                    <HeaderStyle Width="180px" Font-Size="X-Small"/>
                    <ItemStyle Width="180px" Font-Size="X-Small" />
                    </telerik:GridBoundColumn>
                    ...
                    <HeaderStyle Width="90px" Font-Size="X-Small" />
                    ...
                    <HeaderStyle Width="135px" Font-Size="X-Small" />
                ...
                <h6>Loaner History</h6>
                    ...
                    <telerik:RadGrid ID="LoanerHistory" runat="server" AllowSorting="True" ClientSettings-Resizing-AllowColumnResize="true" 
                      ...
                      <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDS_LoanerHistory" Font-Size="X-Small" Width="1000px" ItemStyle-VerticalAlign="Top">
                          <Columns>
                              <telerik:GridBoundColumn DataField="curuser" HeaderText="User" HeaderStyle-Width="120px" ItemStyle-Width="120px" ItemStyle-Font-Size="X-Small" 
                                  SortExpression="curuser" UniqueName="curuser">
                              </telerik:GridBoundColumn>
                              <telerik:GridBoundColumn DataField="OrderNo" HeaderText="Order" HeaderStyle-Width="70px" ItemStyle-Width="70px" ItemStyle-Font-Size="X-Small" 
                                  SortExpression="OrderNo" UniqueName="OrderNo">
                              </telerik:GridBoundColumn>
                              <telerik:GridBoundColumn DataField="cursponsor" HeaderText="Sponsor" HeaderStyle-Width="75px" ItemStyle-Width="75px" ItemStyle-Font-Size="X-Small" 
                                  SortExpression="cursponsor" UniqueName="cursponsor">
                              </telerik:GridBoundColumn>
                              <telerik:GridBoundColumn DataField="Action" HeaderText="Action" HeaderStyle-Width="75px" ItemStyle-Width="75px" ItemStyle-Font-Size="X-Small" 
                                  SortExpression="Action" UniqueName="Action">
                              </telerik:GridBoundColumn> 
                              <telerik:GridBoundColumn DataField="OutDt" DataType="System.DateTime" HeaderStyle-Width="60px" ItemStyle-Width="60px" ItemStyle-Font-Size="X-Small" 
                                  HeaderText="Out" SortExpression="OutDt" UniqueName="OutDt" DataFormatString="{0:MM/dd/yy}" >
                              </telerik:GridBoundColumn>
                              <telerik:GridBoundColumn DataField="DueDt" DataType="System.DateTime" HeaderStyle-Width="60px" ItemStyle-Width="60px" ItemStyle-Font-Size="X-Small" 
                                  HeaderText="Due" SortExpression="DueDt" UniqueName="DueDt" DataFormatString="{0:MM/dd/yy}">
                              </telerik:GridBoundColumn>
                 
                              <telerik:GridBoundColumn DataField="Note" HeaderText="Note" HeaderStyle-Width="150px" ItemStyle-Width="150px" ItemStyle-Font-Size="X-Small" 
                                  SortExpression="Note" UniqueName="Note">
                              </telerik:GridBoundColumn>
                              <telerik:GridBoundColumn DataField="UpdateBy" HeaderText="Update By" HeaderStyle-Width="120px" ItemStyle-Width="120px" ItemStyle-Font-Size="X-Small" 
                                  SortExpression="UpdateBy" UniqueName="UpdateBy">
                              </telerik:GridBoundColumn>
                              <telerik:GridBoundColumn DataField="timestmp" DataType="System.DateTime" DataFormatString="{0:G}" HeaderStyle-Width="140px" ItemStyle-Width="140px" ItemStyle-Font-Size="X-Small" 

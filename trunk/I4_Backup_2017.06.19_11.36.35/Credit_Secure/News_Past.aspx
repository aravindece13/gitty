<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/Credit_Secure.master" AutoEventWireup="false" CodeFile="News_Past.aspx.vb" Inherits="Credit_Secure_News_Past" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContentPlaceHolder" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" Runat="Server">

<h1>Credit | Past News</h1>
...
<div id="News" style="padding:0px 2px 2px 5px;float:left;height:90%;width:96%;">
    ...
    <telerik:RadListView ID="RadListView1" runat="server"  
     ...
     <asp:SqlDataSource ID="SqlDataSourceNews" runat="server" 
         ...
         AND TopicArea IN ('Credit') AND (DATEDIFF(dd, EndDate, { fn NOW() }) &lt; 180)

...
Partial Class Reports2_Operations_CycleCounts_CycleCount_Supplemental_live
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ServerReport.ReportPath = "/Operations/CycleCounts/CycleCount_Supplemental_Live"
    End Sub

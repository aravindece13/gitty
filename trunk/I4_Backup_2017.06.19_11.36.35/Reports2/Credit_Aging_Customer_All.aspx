<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/Popups.master" AutoEventWireup="false" CodeFile="Credit_Aging_Customer_All.aspx.vb" Inherits="Reports2_Credit_Aging_Customer_All" %>
...
<div style="width:1150; height:800px; margin:15px;">    
   <h4>Credit | AR Aging | All Customers</h4>
   <div style="width:1000px; font-size:small;float:left;">
        <b>Data Source: </b> <i>SXe (GUI) Live</i><br /><br /> 
        <b>Report Description: </b>AR aging for all customers<br />

...
Partial Class Reports2_IT_IntranetProfiles
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            'Dim xlsFileName As String = myReader("Custname") + "_" + myReader("ProjectName") + "_" + myReader("ProjectSubtitle") + "_" + myReader("QuoteName") + "_" + "SXeQuoteOrder" + "_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + "_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.LongTime).ToString() + ".xls"


            'DKConnection1.Close()

            Dim xlsFileName As String = "IntranetUserProfiles_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + "_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.LongTime).ToString() + ".xls"

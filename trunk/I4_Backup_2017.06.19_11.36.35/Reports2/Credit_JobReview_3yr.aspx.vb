...
Partial Class Reports2_Credit_JobReview_3yr
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ServerReport.ReportPath = "/Credit/Credit_JobReview_3yr"

        ReportViewer1.ProcessingMode = ProcessingMode.Remote

        Dim xlsFileName As String = "JobSetupReview3Yr_" + "MLQ" + "_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".xlsx"

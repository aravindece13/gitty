...
Partial Class BidTool_Bid
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            Try
                ...
                lnkGrablistComp.NavigateUrl = "~/Reports2/Quote_SXe_GrablistComp.aspx?JobID=" + hdnJobID.Value.ToString()
        ...
        lnkGrablistComp.NavigateUrl = "~/Reports2/Quote_SXe_GrablistComp.aspx?QuoteID=" + Request.QueryString("QuoteID").ToString() + "&TakeOffID=" + hdnTakeOffID.Value.ToString()
    ...
    Protected Sub btnUpdateCustomer_Click(sender As Object, e As System.EventArgs) Handles btnUpdateCustomer.Click
        ...
        Dim updateCMD1 As SqlCommand = New SqlCommand("uspQuoteCustomerUpdate", DKConnection)
        ...
        updateCMD1.Parameters.Add("@CustName", SqlDbType.NVarChar).Value = uCustName.Value.ToString()
        updateCMD1.Parameters.Add("@CustID", SqlDbType.NVarChar).Value = uCustID.Value.ToString()
        updateCMD1.Parameters.Add("@PriceType", SqlDbType.NVarChar).Value = uPriceType.Value.ToString()
    ...
    Protected Sub btnHideQuote_Click(sender As Object, e As System.EventArgs) Handles btnHideQuote.Click
        Dim DKConnectionString As String = WebConfigurationManager.ConnectionStrings("DKConnectionString").ConnectionString
        Dim DKConnection As New SqlConnection(DKConnectionString)

        Dim updateCMD1 As SqlCommand = New SqlCommand("uspQuoteHide", DKConnection)
        updateCMD1.CommandType = CommandType.StoredProcedure
        updateCMD1.Parameters.Add("@QuoteID", SqlDbType.BigInt).Value = hdnQuoteID.Value
        ...
        Finally
            ...
            btnHideQuote.Text = "To Be Hidden"
            ...
            'Dim eMailTo As String = "'" + "devadmin@danakepner.com, " + Request.Cookies("eMail").ToString() + "'"
            Dim eMailTo As String = "devadmin@danakepner.com " + "," + Request.Cookies("eMail").Value.ToString()
            mMailMessage.To.Add(eMailTo)

            mMailMessage.Subject = "Quote Hidden: " + hdnQuoteID.Value.ToString() + " " + Request.Cookies("FullName").Value.ToString()
            ' Set the body of the mail message

            mMailMessage.Body = "QuoteID: " + hdnQuoteID.Value.ToString() + " " + Request.Cookies("FullName").Value.ToString()
    ...
    Protected Sub btnTakeOffAssignUpdate_Click(sender As Object, e As System.EventArgs) Handles btnTakeOffAssignUpdate.Click
        ...
        Dim DKConnectionString7 As String = WebConfigurationManager.ConnectionStrings("DKConnectionString").ConnectionString
        Dim DKConnection7 As New SqlConnection(DKConnectionString)

        Dim updateCMD7 As SqlCommand = New SqlCommand("uspQuoteUtilityTakeOffAssignChangePricingCheck", DKConnection7)
        updateCMD7.CommandType = CommandType.StoredProcedure
        updateCMD7.Parameters.Add("@QuoteID", SqlDbType.BigInt).Value = hdnQuoteID.Value
        updateCMD7.Parameters.Add("@TakeOffID", SqlDbType.BigInt).Value = comboBoxTakeOffAssign.SelectedValue
        updateCMD7.Parameters.Add("@JobID", SqlDbType.BigInt).Value = hdnJobID.Value
        ...
        Try
            'Try to open the connection and execute the update
            DKConnection7.Open()
            updated = updateCMD7.ExecuteNonQuery()
    ...
    Protected Sub listBoxTakeOffAssemblies_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles listBoxTakeOffAssemblies.SelectedIndexChanged
        ...
        insertCMD.Parameters.Add("@PriceType", SqlDbType.NVarChar).Value = hdnPriceType.Value
        insertCMD.Parameters.Add("@CustID", SqlDbType.NVarChar).Value = hdnCustID.Value
        insertCMD.Parameters.Add("@TaxRate", SqlDbType.Real).Value = txtBoxTaxRateUpdate.DbValue / 100

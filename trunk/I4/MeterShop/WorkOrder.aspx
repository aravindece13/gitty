        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnAddBatch" >
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="addRate1"  />
                    <telerik:AjaxUpdatedControl ControlID="addRate2"  />
                    <telerik:AjaxUpdatedControl ControlID="addRate3"  />
                    <telerik:AjaxUpdatedControl ControlID="lblAddFlowLow"  />
                    <telerik:AjaxUpdatedControl ControlID="lblAddFlowMed"  />
                    <telerik:AjaxUpdatedControl ControlID="lblAddFlowHi"  />
                        ...
                        <asp:Panel ID="pnlAddBatch" runat="server"  >
                            <div style="width:275px; float:left;">
                                ...
                                <div style="float:left; width:275px; margin-top:20px;">
                                    <telerik:RadButton ID="btnAddBatch" runat="server" Text="Add Batch" Width="200px" Skin="BlackMetroTouch" UseSubmitBehavior="TRUE" AutoPostBack="true" ></telerik:RadButton>
                                </div>
                        ...
                        <div style="width:250px; float:left; ">
                            ...
                            <div style="margin-top:10px; width:275px; height:615px;">
                                <telerik:RadGrid ID="grdBatchID1" runat="server" Width="275px" Height="615px" 
                                                 DataSourceID="SqlDS_grdBatchIDs" 

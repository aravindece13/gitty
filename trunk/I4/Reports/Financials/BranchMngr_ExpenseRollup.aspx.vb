...
Partial Class Reports_Financials_BranchMngr_ExpenseRollup
    ...
    Protected Sub ReportViewer1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ReportSource.Parameters(0).Value = Whse1
        ReportViewer1.ReportSource.Parameters(1).Value = Whse2
        ReportViewer1.ReportSource.Parameters(2).Value = Whse3
        ReportViewer1.ReportSource.Parameters(3).Value = Whse4
        ReportViewer1.ReportSource.Parameters(4).Value = Whse5

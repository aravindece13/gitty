<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/IT_Secure.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="IT_Secure_Default" %>
...
<h1>IT | News</h1>
 ...
 <div id="News" style="padding:2px 5px 2px 5px; width:95%; height:75%;">   
     <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" >
         <Tabs>
             <telerik:RadTab runat="server" Text="IT" Value="IT"></telerik:RadTab>
         </Tabs>
     </telerik:RadTabStrip>
                    ...
                    <FormTemplate>
                        <div id="divEditItem" style="width:100%;padding:3px 0px 3px 40px; height:350px;background-color: yellow;">
                            ...
                            <div id="divEditLine3" style="padding:0px 0px 0px 10px;">
                                <telerik:RadEditor ID="NewsItem" runat="server" Content='<%# Bind("NewsItem") %>' Font-Names="Century Gothic" 

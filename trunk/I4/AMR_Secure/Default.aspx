<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/AMR_Secure.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="AMR_Secure_Default" %>
...
<h1>AMR | News</h1>
 ...
 <div id="News" style="padding:2px 5px 2px 5px; width:95%; height:75%;">   
     <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" >
         <Tabs>
             <telerik:RadTab runat="server" Text="AMR" Value="AMR"></telerik:RadTab>
                            ...
                            <div id="divEditLine1" style="padding:0px 0px 0px 10px;">
                                ...
                                <telerik:RadComboBox ID="TopicArea" runat="server" Width="160px" 
                                    ...
                                    <Items>
                                        ...
                                        <telerik:RadComboBoxItem runat="server" Text="MeterShop" Value="MeterShop" />

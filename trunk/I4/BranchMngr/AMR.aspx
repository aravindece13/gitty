<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/BranchMngr.master" AutoEventWireup="false" CodeFile="AMR.aspx.vb" Inherits="BranchMngr_AMR" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContentPlaceHolder" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" Runat="Server">

<h1>Branch Manager | AMR Account Tracking</h1>
...
<telerik:RadMultiPage ID="RadMultiPage1" runat="server" Height="570px" Width="1000px">
  ...
  <telerik:RadPageView ID="Customers" runat="server" Selected="true">                              
     <div id="divCustSearch" style="padding:0px 5px 5px 5px;float:left;width:995px;">                                      
         ...
         <telerik:RadGrid ID="RadGridCustSearch" runat="server" Width="1000px" Height="200px" 
            ...
            <ClientSettings Selecting-AllowRowSelect="true"   
             ...
             <MasterTableView AutoGenerateColumns="False" DataKeyNames="CUSTKEY, CustID" 
                 DataSourceID="SqlDS_CustSearch" >
    ...
    <telerik:RadTabStrip ID="RadTabStrip2" runat="server" MultiPageID="RadMultiPage2"  
        ...
        <telerik:RadMultiPage ID="RadMultiPage2" runat="server" Height="300px" 
                Width="1000px" SelectedIndex="0">
         ...
         <asp:SqlDataSource ID="SqlDS_CustProjects" runat="server" 
            ...
            <%--<telerik:RadPageView ID="Reports" runat="server" Selected="false" BorderColor="SteelBlue" BorderWidth="1px" Height="300px" Width="1000px">
        ...
        <EmptyDataTemplate>
         ...
         <asp:SqlDataSource ID="SqlDS_ProjectComments" runat="server" 
                ...
                <%--<SelectParameters>
                    ...
                    <a    WHERE (aAcct_Customers.Region = @Region1) OR (aAcct_Customers.Region = @Region2) OR (aAcct_Customers.Region = @Region3) OR (aAcct_Customers.Region = @Region4) OR (aAcct_Customers.Region = @Region5)sp:CookieParameter CookieName="Region1" DefaultValue="0" Name="Region1" Type="String" />
                    <asp:CookieParameter CookieName="Region2" DefaultValue="0" Name="Region2" Type="String" />
                    <asp:CookieParameter CookieName="Region3" DefaultValue="0" Name="Region3" Type="String" />
                    <asp:CookieParameter CookieName="Region4" DefaultValue="0" Name="Region4" Type="String" />
                    <asp:CookieParameter CookieName="Region5" DefaultValue="0" Name="Region5" Type="String" />

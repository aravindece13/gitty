                                    ...
                                    <div style="width:500px; float:left; margin-bottom:15px; border:2px solid #4c68a2;">
                                        ...
                                        <div style="width:500px; float:left;">
                                            ...
                                            <asp:SqlDataSource ID="SqlDS_grdOpenPTRequests" runat="server" 
                                                ConnectionString="<%$ ConnectionStrings:DKConnectionString %>" 
                                                SelectCommand= "SELECT R.CustID, R.CustName, R.NewPriceType, R.OldPriceType, R.RequestID, R.RequestDateTime, Customers.PriceType FROM Matrix_CustPriceTypeChangeRequests R INNER JOIN Customers ON R.CustID = Customers.CustID WHERE Customers.PriceType <> R.NewPriceType ORDER BY R.RequestDateTime DESC">
                                            </asp:SqlDataSource>
                                        </div>

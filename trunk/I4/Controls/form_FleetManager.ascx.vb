...
Partial Class Controls_form_FleetManager
    ...
    Protected Sub RadGridVehicleList_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadGridVehicleList.SelectedIndexChanged
        ...
        If Page.IsPostBack Then
            ...
            selectSQL &= "warrantyservice, warrantydesc, gvwr, carryweight, actualweight, tiresize, engine, gascard, other, leaseamount, taxautouser, taxautouser, paycomid, leaseamount "
            ...
            Try
                ...
                LeaseAmount.Text = Reader("leaseamount")
                TaxAutoUser.SelectedValue = Reader("PayComID")
                ...
                LeaseAmount.Text = Reader("LeaseAmount")
                TaxAutoUser.SelectedValue = Reader("PayComID")
                PayComID.Value = Reader("PayComID")
    ...
    Protected Sub btnUpdateOwnershipInfo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdateOwnershipInfo.Click
        ...
        updateSQL2 &= "lease_enddt=@lease_enddt,ownerhistory=@ownerhistory,leasingco=@leasingco,disposedt=@disposedt,TaxAutoUser=@TaxAutoUser, PayComID = @PayComID, LeaseAmount = @LeaseAmount "
        ...
        'updateCmd2.Parameters.AddWithValue("@TaxAutoUser", TaxAutoUser.SelectedItem)
        'updateCmd2.Parameters.AddWithValue("@PayComID", TaxAutoUser.SelectedValue)
        updateCmd2.Parameters.AddWithValue("@TaxAutoUser", TaxAutoUser.Text)
        updateCmd2.Parameters.AddWithValue("@PayComID", TaxAutoUser.SelectedValue)

        updateCmd2.Parameters.AddWithValue("@LeaseAmount", LeaseAmount.Text)

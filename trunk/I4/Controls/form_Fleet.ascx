        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="VehicleList">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="pnlAddMileageLog" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="grdMileageLog" LoadingPanelID="RadAjaxLoadingPanel1" />
            ...
            <telerik:AjaxSetting AjaxControlID="btnAddMileage">
                <UpdatedControls>
...
<asp:SqlDataSource ID="SqlDS_MileageLog" runat="server" 
     ConnectionString="<%$ ConnectionStrings:DKConnectionString %>" 
     SelectCommand="uspFleetLogListingByVehicleID" SelectCommandType="StoredProcedure">
     <SelectParameters>
         <asp:ControlParameter ControlID="VehicleList" Name="VehicleID" PropertyName="SelectedValue" Type="Int32" DefaultValue="0" />
     </SelectParameters>
</asp:SqlDataSource>


<div style="Margin: 0px 5px 5px 10px; width:1400px;">
    
        <%--<div > --%>   
            <div style="width:320px; float:left; margin: 5px 10px 15px 0px; border:2px solid #4c68a2;">  
                ...
                <telerik:RadListBox ID="VehicleList" runat="server" Height="710px" Width="300px" DataSourceID="SqlDS_VehicleList" SelectionMode ="Single" 
        ...
        <div style="width:900px; height:750px; float:left; margin: 0px 0px 0px">
            <div id="divVehiclesDetails" style="width:900px;height:470px; float:left;Margin:0px 0px 15px 0px;vertical-align:top;" >
                    <div>
                    ...
                    <div style="width:900px;">
                         <telerik:RadTabStrip ID="RadTabStrip2" runat="server" MultiPageID="RadMultiPage2" SelectedIndex="2" Width="900px" Skin="MetroTouch">
                            <Tabs>
                                ...
                                <telerik:RadTab runat="server" Text="Mileage Log" PageViewID="MileageLog" ></telerik:RadTab>
                    ...
                    <div style="width:900px; height:400px;">
                        <telerik:RadMultiPage ID="RadMultiPage2" runat="server" Height="400px" Width="900px" >
                
                               <telerik:RadPageView ID="VehicleInfo" runat="server" Selected="true" Width="900px" Height="400px" BorderColor="SteelBlue" BorderWidth="1px" >
                                    <div id="div2" style="Margin:5px 5px 5px 15px;float:left;width:750px;">
                                         <telerik:RadAjaxPanel ID="RadAjaxPanelVehicleInfo" runat="server" Height="400px" Width="750px" >
                                            <div style="width:850px; float:left;">
                                                <div style="height:40px; width:235px; float:left;">
                                                    <telerik:RadTextBox ID="vin" runat="server" Label="Vin:" LabelWidth="75px" ReadOnly="true" Width="220px" LabelCssClass="myLabelCss"></telerik:RadTextBox>
                                                </div>
                                                <div style="height:40px; width:235px; float:left;">
                                                    <telerik:RadTextBox ID="plate" runat="server" ReadOnly="true" Label="Plate:" LabelWidth="75px" Width="220px" LabelCssClass="myLabelCss"></telerik:RadTextBox>
                                                </div>
                                                <div style="height:40px; width:235px; float:left;">
                                                    <telerik:RadTextBox ID="dkunit" runat="server" ReadOnly="true" Label="Unit:" LabelWidth="75px" Width="220px" LabelCssClass="myLabelCss"></telerik:RadTextBox>
                                                </div>
                                            ...
                                            <div style="width:850px; float:left;">
                                                <div style="height:40px; width:235px; float:left;">
                                                    <telerik:RadTextBox ID="Make" runat="server" ReadOnly="true" Label="Make:" LabelWidth="75px" Width="220px" LabelCssClass="myLabelCss"></telerik:RadTextBox>
                                                </div>
                                                <div style="height:40px; width:235px; float:left;">
                                                    <telerik:RadTextBox ID="model" runat="server" ReadOnly="true" Label="Model:" LabelWidth="75px" Width="220px" LabelCssClass="myLabelCss"></telerik:RadTextBox>
                                                </div>
                                                <div style="height:40px; width:140px; float:left;">
                                                    <telerik:RadTextBox ID="ModelYr" runat="server" ReadOnly="true" Label="Year:" LabelWidth="75px" Width="140px" LabelCssClass="myLabelCss"></telerik:RadTextBox>
                                                </div>
                                                <div style="height:40px; width:165px; float:left;">
                                                    <telerik:RadTextBox ID="fueltype" runat="server" ReadOnly="true" Label="Fuel:" LabelWidth="60px" Width="135px" LabelCssClass="myLabelCss"></telerik:RadTextBox> 
                                                </div>
                                            
                                            </div>
                                            <div style="width:850px; float:left;">
                                                <div style="height:40px; width:235px; float:left;">
                                                    <telerik:RadTextBox ID="driver_namef" runat="server" ReadOnly="true" Label="Driver (F):" LabelWidth="75px" Width="220px" LabelCssClass="myLabelCss"></telerik:RadTextBox>
                                                </div>
                                                <div style="height:40px; width:235px; float:left;">
                                                    <telerik:RadTextBox ID="driver_namel" runat="server" ReadOnly="true" Label="Driver (L):" LabelWidth="75px" Width="220px" LabelCssClass="myLabelCss"></telerik:RadTextBox>
                                                </div>
                                            </div>
                                            
                                            <div style="width:850px; height:50px;Margin:10px;">
                                                <telerik:RadTextBox ID="description" runat="server" Label="Additional Description:" ReadOnly="true" Wrap="true" Width="800px" LabelCssClass="myLabelCss"></telerik:RadTextBox>
                               ...
                               <telerik:RadPageView ID="VehicleDetails" runat="server" Width="900px" Height="400px" BorderColor="SteelBlue" BorderWidth="1px" >
                               ...
                               <telerik:RadPageView ID="MileageLog" runat="server" Width="900px" Height="400px" BorderColor="SteelBlue" BorderWidth="1px" >
                                    <div style="Margin:0px 0px 0px 0px; float:left;height:50px; width:900px;">
                                       <asp:Panel ID="pnlAddMileageLog" runat="server" Width="800px" Height="50px"> 
                                            <asp:HiddenField ID="hdnOdoBegin" runat="server" />
                                            <asp:HiddenField ID="hdnLastLog" runat="server" />
                                            <div style="width:800px; margin: 10px 0px 10px 10px; float:left;">
                                                 <div style="width:400px; float:left;"> 
                                                    <telerik:RadNumericTextBox ID="odoEnd" runat="server" Width="250px" Label="Current Odometer:" LabelWidth="130px"
                                                 ...
                                                 <div style="Margin: width:250px; float:left;">
                                    
                                                        <telerik:RadButton ID="btnAddMileage" runat="server" Text="Add Mileage" Width="200px" Skin="BlackMetroTouch"></telerik:RadButton>
                                    ...
                                    <div>
                                        ...
                                        <telerik:RadGrid ID="grdMileageLog" runat="server" DataSourceID="SqlDS_MileageLog"
                                                        AllowPaging="True" AllowSorting="True" Width="875px" Height="375px"   >
                                            ...
                                            <MasterTableView DataSourceID="SqlDS_MileageLog" PageSize="50" AutoGenerateColumns="False" Width="875px" >
                                            ...
                                            <Columns>
                                                     ...
                                                     <telerik:GridBoundColumn DataField="LoggedBy" HeaderText="LoggedBy" SortExpression="LoggedBy" UniqueName="LoggedBy">
                                                        <ItemStyle Wrap="false" HorizontalAlign="Left" Width="200px"  VerticalAlign="Top" />
                                                     ...
                                                     <%--<telerik:GridBoundColumn DataField="DaysBetweenLogs" DataType="System.Decimal" HeaderText="Days Since Last Log" SortExpression="DaysBetweenLogs" UniqueName="DaysBetweenLogs" DataFormatString="{0:n0}" >
                                                     ...
                                                     <telerik:GridBoundColumn DataField="MilesPerMonth" DataType="System.Decimal" HeaderText="Miles/Month" DataFormatString="{0:n0}" ReadOnly="True" SortExpression="MilesPerMonth" UniqueName="MilesPerMonth">
                                                        <ItemStyle Wrap="false" HorizontalAlign="Left" Width="100px"  VerticalAlign="Top" />
                                                        <HeaderStyle Width="100px" />
                                                     </telerik:GridBoundColumn>
                                                     ...
                                                     <telerik:GridBoundColumn DataField="VehicleDescription"  HeaderText="Vehicle Description" ReadOnly="True" 
                                                        ...
                                                        <ItemStyle Wrap="false" HorizontalAlign="Left" Width="175px"  VerticalAlign="Top" />
                               ...
                               <telerik:RadPageView ID="PastService" runat="server" Width="900px" Height="400px" BorderColor="SteelBlue" BorderWidth="1px" >
                                        <div id="div6" style="Margin:5px;float:left;">
                                            <telerik:RadAjaxPanel ID="RadAjaxPanelPastService" runat="server" Width="900px" Height="400px">
                                                  <telerik:RadGrid ID="RadGridService" runat="server" DataSourceID="SqlDS_PastService"
                                                        AllowPaging="True" AllowSorting="True" AllowFilteringByColumn="True" Width="875px" Height="375px"   >
            ...
            <div id="divAddService" style="width:900px; height:250px;float:left; ">
                        <%--<telerik:RadAjaxPanel ID="RadAjaxPanelAddService" runat="server" >--%>
                        <asp:Panel ID="pnlAddService" runat="server" Width="900px" Height="350px">
        
                  <div style="Margin:0px 0px 0px 0px; float:left; border-style:solid; border-color:Green; height:250px; width:900px;">
                                <div style="background:Green; width:900px; height:20px; "> 
                                     <asp:Label ID="lblAddServiceTitle" runat="server" Font-Bold="true" ForeColor="White" Font-Size="Medium" Height="15px" ></asp:Label>
                                </div>
        
                            <div style="Margin:10px 0px 0px 5px; width:900px; height:200px;">

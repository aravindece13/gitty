...
Partial Class Controls_form_EmployeeData
    ...
    Protected Sub btnUpdatePastEmployee_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdatePastEmployee.Click
        ...
        updateSQL = "UPDATE HR_Employees SET status= @Status "
        updateSQL &= "WHERE employeeid = @hdnemployeeid"
        ...
        'updateCmd.Parameters.AddWithValue("@hdnemployeeid", 1069)
        updateCmd.Parameters.AddWithValue("@status", pStatus.SelectedValue).ToString()
        ...
        'updateCmd.Parameters.AddWithValue("@dept", pdept.SelectedValue).ToString()
        ...
        'updateCmd.Parameters.AddWithValue("@state", pState.SelectedValue).ToString()
        ...
        'updateCmd.Parameters.AddWithValue("@bmonth", pBmonth.SelectedValue).ToString()
        'updateCmd.Parameters.AddWithValue("@notes", pnotes.Text)

        'updateCmd.Parameters.AddWithValue("@title", pjobtitle.Text)
        'updateCmd.Parameters.AddWithValue("@branchno", pBranchno.SelectedValue).ToString()

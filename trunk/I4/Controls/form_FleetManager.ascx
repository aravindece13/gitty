        ...
        <div style="width:1750px;Margin: 10px; ">                  
             <div style="width:1750px; float:left; height:40px;">
                ...
                <div style="width:300px; float:left;">
                    ...
                    <asp:SqlDataSource ID="SqlDS_fMake" runat="server" ConnectionString="<%$ ConnectionStrings:DKConnectionString %>" 
        ...
        <div id="divVehiclesTop" style="padding:0px 5px 0px 5px;float:left;width:1500px;height:225px;"  >
                ...
                <telerik:RadGrid ID="RadGridVehicleList" runat="server"  DataSourceID="SqlDS_FleetList" GridLines="None" Width="1450px" Height="225px"  
                    ...
                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="id" ClientDataKeyNames="id" DataSourceID="SqlDS_FleetList" PageSize="50">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="LeaseAmount" DataFormatString="{0:c2}" 
                                                DataType="System.Decimal" HeaderText="Mo. Lease" ReadOnly="True" UniqueName="LeaseAmount">
                                <ItemStyle Width="75px" HorizontalAlign="Right"  />
                                <HeaderStyle Width="75px"  />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="TaxAutoUser" HeaderText="Tax Auto User" SortExpression="TaxAutoUser" UniqueName="TaxAutoUser" >
                                <ItemStyle Width="100px"  />
                                <HeaderStyle Width="100px"  />
                            </telerik:GridBoundColumn>
                ...
                <asp:SqlDataSource ID="SqlDS_FleetList" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:DKConnectionString %>" 
                     SelectCommand="uspFleetListingFilterable" SelectCommandType="StoredProcedure" >
                
                    <SelectParameters>
                        <asp:ControlParameter ControlID="fStatus" DefaultValue="Active" Name="fStatus"  PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="fLocation" DefaultValue="%" Name="fLocation"  PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="fMake" DefaultValue="%" Name="fMake"  PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="fDriver" DefaultValue="%" Name="fDriver"  PropertyName="Text" />
                        <asp:ControlParameter ControlID="fVIN" DefaultValue="%" Name="fVIN"  PropertyName="Text" />
                        <asp:ControlParameter ControlID="fLeaseUnit" DefaultValue="%" Name="fLeaseUnit"  PropertyName="Text" />
                        <asp:ControlParameter ControlID="fDKUnit" DefaultValue="%" Name="fDKUnit"  PropertyName="Text" />
                    ...
                    <telerik:RadPageView ID="OwnershipPage" runat="server" Width="1450px" >
                          <div id="div4" style="Margin:0px 0px 5px 10px;float:left;width:1450px;">
                                <telerik:RadAjaxPanel ID="RadAjaxPanelOwnership" runat="server" >
                                   ...
                                   <div style="width:350px; float:left; margin-left:10px;">
                                        <div style="margin: 0px 0px 5px 0px; width:250px;">
                                            <telerik:RadNumericTextBox ID="price_delivery" runat="server" Label="Orig. Price:" LabelWidth="95px" Width="200px"   
                                                    EnabledStyle-HorizontalAlign="Right" NumberFormat-DecimalDigits="0" Type="Currency" LabelCssClass="myLabelCss" >
                                            </telerik:RadNumericTextBox>
                                        </div>
                                        <div style="margin: 0px 0px 5px 0px; width:250px;">
                                            <telerik:RadNumericTextBox ID="price_sold" runat="server"  Label="Sell Price:" LabelWidth="95px" Width="200px"
                                                    EnabledStyle-HorizontalAlign="Right" NumberFormat-DecimalDigits="0" Type="Currency" LabelCssClass="myLabelCss" >
                                            </telerik:RadNumericTextBox>
                                        </div>
                                        <div style="margin: 0px 0px 5px 0px; width:250px;">
                                            <telerik:RadNumericTextBox ID="LeaseAmount" runat="server"  Label="Month Lease:" LabelWidth="95px" Width="200px"
                                                    EnabledStyle-HorizontalAlign="Right" NumberFormat-DecimalDigits="2" Type="Currency" LabelCssClass="myLabelCss" >
                                            </telerik:RadNumericTextBox>
                                        </div>
                                        <div style="margin: 0px 0px 5px 0px; width:300px;">
                                            <telerik:RadComboBox ID="TaxAutoUser" runat="server" Enabled="true"  Label="Taxable User:"
                                                        DataSourceID="SqlDS_TaxAutoUser" DataValueField="PayComID" DataTextField="FullName" 
                                                        Width="190px" Height="250px" LabelCssClass="myLabelCss" AppendDataBoundItems="true">
                                                <Items>
                                                    <telerik:RadComboBoxItem Text="-" Value="-" />
                                                </Items>
                                            </telerik:RadComboBox>

                                            <asp:HiddenField ID="PayComID" runat="server" />
                                        </div>
                                   </div>
                                   <div style="width:350px; margin-left:10px; float:left;">
                                   ...
                                   <div style="width:1100px; margin:10px 0px 10px 0px;";>
                                    ...
                                    <asp:SqlDataSource ID="SqlDS_TaxAutoUser" runat="server" ConnectionString="<%$ ConnectionStrings:IntranetAppServices %>" 
                                            SelectCommand="SELECT FullName, PayComID FROM [dbo].[Intranet_Personalization] WHERE Status = 'Active' AND PayComID <> '0'  ORDER BY FullName">
                                     </asp:SqlDataSource>
  ...
  <telerik:RadPageView ID="Reports" runat="server" >
        <div id="div7" style="padding:15px 5px 5px 15px;float:left; height:470px;width:1800px;">
           ...
           <div id="div9" style="margin:0px 0px 0px 0px;float:left;width:1300px;float:left;">
                ...
                <div style="width:1300px; margin: 30px 0px 0px 0px;">
	                <div style="width:300px;float:left; margin:10px;">
                        <telerik:RadButton ID="lnkVehicleMileageReport" ButtonType="LinkButton" runat="server" Width="250px" Skin="BlackMetroTouch" Text="Vehicle Mileage" NavigateUrl="../Reports2/Fleet_MileageReport.aspx" Target="_blank"></telerik:RadButton>
        	        </div>
         	        <div style="width:700px; font-size:Small;float:left; margin-bottom:10px;">
                        <b>Data Source: </b><i>DK datawarehouse</i><br /><br /> 
                        <b>Report Description: </b>Excel listing of active fleet vehicles with last odometer reading, and the date of the last mileage log.  
                        <br /><br />
                        <b>Report Use: </b>The report exports directly to an Excel file for further manipulation.
                    </div>
                ...
                <div style="width:1300px; margin: 30px 0px 0px 0px;">
	                <div style="width:300px;float:left; margin:10px;">
                        <telerik:RadButton ID="lnkWhseLogs" ButtonType="LinkButton" runat="server" Width="250px" Skin="BlackMetroTouch" Text="Whse Mileage Logs" NavigateUrl="../Reports2/Fleet_MileageLog_Whse.aspx" Target="_blank"></telerik:RadButton>
        	        </div>
         	        <div style="width:700px; font-size:Small;float:left; margin-bottom:10px;">
                        <b>Data Source: </b><i>DK datawarehouse</i><br /><br /> 
                        <b>Report Description: </b>Excel listing of active warehouse fleet vehicles with last odometer reading, date of the last mileage log, and the archive of all mileage logs for active vehicles.  
                        <br /><br />
                        <b>Report Use: </b>The report exports directly to an Excel file for further manipulation.
                    </div>

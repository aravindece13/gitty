<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/Operations_Secure.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Operations_Secure_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContentPlaceHolder" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" Runat="Server">

<h1>Operations | News</h1>
 ...
 <div id="News" style="padding:2px 5px 2px 5px; width:95%; height:75%;">   
     <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" >
         <Tabs>
             <telerik:RadTab runat="server" Text="Operations" Value="Operations"></telerik:RadTab>
             <telerik:RadTab runat="server" Text="Accounting" Value="Accounting"></telerik:RadTab>
             <telerik:RadTab runat="server" Text="Credit" Value="Credit"></telerik:RadTab>
             <telerik:RadTab runat="server" Text="General" Value="General"></telerik:RadTab>
             <telerik:RadTab runat="server" Text="Purchasing" Value="Purchasing"></telerik:RadTab>
             <telerik:RadTab runat="server" Text="Sales" Value="Sales" Selected="True"></telerik:RadTab>
             <telerik:RadTab runat="server" Text="Warehouse" Value="Warehouse" Selected="True"></telerik:RadTab>
         </Tabs>
     </telerik:RadTabStrip>
    ...
    <asp:SqlDataSource ID="SqlDataSourceNews" runat="server" 
        ...
        SelectCommand="SELECT [NewsID], [TopicArea], [StartDate], [EndDate], [Headline], [NewsItem], [CreatedBy],
                      [CreatedDate], [ModifiedBy], [ModifiedDate], [DisplayPriority], [Tags] 
                        FROM [aNews] 
                        WHERE ([TopicArea] LIKE @TopicArea) AND (StartDate &lt;= { fn NOW() }) AND (EndDate &gt;= { fn NOW() })

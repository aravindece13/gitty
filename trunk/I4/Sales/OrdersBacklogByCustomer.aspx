<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/Sales.master" AutoEventWireup="false" CodeFile="OrdersBacklogByCustomer.aspx.vb" Inherits="Sales_OrdersBacklogByCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" Runat="Server">
 ...
 <h1>Sales | Order Backlog by Customer</h1>
   ...
   <div id="divCollection1" style="float:left; ">  
    ...
    <h6>Customers</h6>
        ...
        <asp:SqlDataSource ID="SqlDS_OrderBacklogCustList" runat="server" 
            ...
            WHERE (Order_Line_Backlog.Outsideslsrep = @salesID1) OR (Order_Line_Backlog.Outsideslsrep = @salesID2) 
            OR (Order_Line_Backlog.Outsideslsrep = @salesID3) OR (Order_Line_Backlog.Outsideslsrep = @salesID4) 
            OR (Order_Line_Backlog.Outsideslsrep = @salesID5) 
    ...
    <div id="divOrderBacklogOrderList" style="float:left;margin:2px 1px 1px 2px;" align="left" >
        ...
        <telerik:RadGrid ID="RadGrid_OrderList" runat="server" DataSourceID="SqlDS_OrderList" 
            ...
            AllowSorting="True" GridLines="None" ClientSettings-Resizing-AllowColumnResize="true" ItemStyle-Wrap="false" ItemStyle-VerticalAlign="Top">
            ...
            <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDS_OrderList" 
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="City" 
                        ...
                        SortExpression="City" ItemStyle-HorizontalAlign="Left" 

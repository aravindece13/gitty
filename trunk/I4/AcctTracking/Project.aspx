<%@ Page Title="Project" Language="VB" MasterPageFile="~/MasterPages/Popups.master" AutoEventWireup="false" CodeFile="Project.aspx.vb" Inherits="AcctTracking_Project" %>
          ...
          <asp:HiddenField ID="ModifiedBy" runat="server" />
            ...
            <div id="divHeader" style="padding:2px 0px 2px 0px;">
               ...
               <div id="divSaleEstMonthYear" style="padding:3px 0px 3px 0px;width:900px;">
                        <telerik:RadNumericTextBox ID="SaleEst" Label="Estimated Sale Value:" Value="0" Type="Currency"
                            NumberFormat-DecimalDigits="0" width="200px"
                            EnabledStyle-HorizontalAlign="Right" EmptyMessageStyle-HorizontalAlign="Right" FocusedStyle-HorizontalAlign="Right" runat="server" >
<FocusedStyle HorizontalAlign="Right"></FocusedStyle>

<EmptyMessageStyle HorizontalAlign="Right"></EmptyMessageStyle>
...
<NumberFormat DecimalDigits="0"></NumberFormat>
        ...
        <div id="divTaskGrid" style="width:425px;height:300px;float:left;">
         ...
         <div id="divTasksRight" style="padding:10px 0px 10px 5px;width:575px;height:300px; vertical-align:top; float:Left;">
             ...
             <telerik:RadTabStrip ID="RadTabStrip1" runat="server"  
                    MultiPageID="RadMultiPage1" SelectedIndex="2"  CausesValidation="false" Width="280px">
                    <Tabs> 
      ...
      <%--</telerik:RadAjaxPanel>--%>
          ...
          <asp:SqlDataSource ID="SqlDS_TaskNotes" runat="server" 
              ...
              <SelectParameters>
                  <asp:ControlParameter ControlID="grdTasks"  Name="TaskIndex" 

...
Partial Class AcctTracking_Project
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        TaskComment.Visible = "false"
        btnAddTaskFeedback.Visible = "false"
        lblTaskFeedbackTitle.Visible = "false"
        lblFeedbackHistory.Visible = "false"
        lvNoteHistory.Visible = "false"
        lblCommentsSelectRow.Visible = "true"
        lblCommentsSelectRow.Text = "Please select a task on the left for which you would like to enter a comment."

...
Partial Class Reports2_CustomerJobs_JobStatus_Qty
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If IsPostBack = "False" Then
            ...
            Dim pdfFileName As String = myReader("Custname") + "_" + myReader("JobName") + "_Qty_" + Now.Date.ToShortDateString() + ".pdf"
            ...
            ReportViewer1.ServerReport.ReportPath = "/Customers/JobStatus_Qty"

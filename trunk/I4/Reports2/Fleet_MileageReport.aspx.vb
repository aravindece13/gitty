...
Partial Class Reports2_Fleet_MileageReport
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ServerReport.ReportPath = "/Fleet/VehicleMiles"

        ReportViewer1.ProcessingMode = ProcessingMode.Remote

        Dim xlsFileName As String = "Fleet_VehicleMiles_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".xlsx"

...
Partial Class Reports2_Quote_Formal2_Excel
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            'selectCMD1.Parameters.Add("@FullName", SqlDbType.NVarChar).Value = Request.Cookies("FullName").Value
            ...
            Dim xlsFileName As String = myReader("Custname") + "_" + myReader("ProjectName") + "_" + myReader("ProjectSubtitle") + "_" + myReader("QuoteName") + ".xlsx"
            ...
            ReportViewer1.ServerReport.ReportPath = "/Quote/Formal2_Excel"

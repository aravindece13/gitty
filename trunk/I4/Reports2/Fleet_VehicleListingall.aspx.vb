...
Partial Class Reports2_Fleet_VehicleListingall
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ServerReport.ReportPath = "/Fleet/VehicleListingAll"

        ReportViewer1.ProcessingMode = ProcessingMode.Remote

        Dim xlsFileName As String = "FleetListing_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".xlsx"

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/Exec.master" AutoEventWireup="false" CodeFile="Orders.aspx.vb" Inherits="Exec_Orders" %>
            ...
            <telerik:RadPageView ID="Lines" runat="server" Width="1300px" >
                <div style="width:1700px; height:40px; Margin:10px 0px 0px 0px;">
                      ...
                      <div style="height:300px; width:1600px;">
                         ...
                         <asp:SqlDataSource ID="SqlDS_grdLines" runat="server" ConnectionString="<%$ ConnectionStrings:DKConnectionString %>" SelectCommand="uspOrdersLinesActiveGetAll" SelectCommandType="StoredProcedure">
                             <SelectParameters>

<%@ Control Language="VB" AutoEventWireup="false" CodeFile="form_PricingModel_old.ascx.vb" Inherits="Controls_form_PricingModel_old" %>
...
<div style="width:1800px; margin:10px;">
    ...
    <div  style="width:1800px;">
        ...
        <div style="width:1550px; float:left; margin-top:20px; ">
            <div style="width:800px; margin-left:220px;">
                <telerik:RadTabStrip ID="RadTabStrip1" runat="server" Skin="BlackMetroTouch" Width="800px" MultiPageID="RadMultiPage1" ResolvedRenderMode="Classic">
                    <Tabs>
                        <telerik:RadTab runat="server" Text="Category View" PageViewID="CatView" Width="200px" />
                        <telerik:RadTab runat="server" Text="Product View" PageViewID="ProductView" Width="200px" Selected="true" />
        ...
        <div style="width:1800px; float:left; ">
            ...
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" ResolvedRenderMode="Classic">
                <telerik:RadPageView ID="CatView" runat="server" Width="1800px" >
                ...
                <telerik:RadPageView ID="ProductView" runat="server" Width="1800px" Selected="true" >

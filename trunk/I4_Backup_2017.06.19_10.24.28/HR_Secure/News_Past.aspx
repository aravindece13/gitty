<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/HR_Secure.master" AutoEventWireup="false" CodeFile="News_Past.aspx.vb" Inherits="HR_Secure_News_Past" %>
...
<div id="News" style="padding:0px 2px 2px 5px;float:left;height:90%;width:96%;">
    ...
    <telerik:RadListView ID="RadListView1" runat="server"  
     ...
     <asp:SqlDataSource ID="SqlDataSourceNews" runat="server" 
         ...
         AND TopicArea IN ('HR','General') AND (DATEDIFF(dd, EndDate, { fn NOW() }) &lt; 180)

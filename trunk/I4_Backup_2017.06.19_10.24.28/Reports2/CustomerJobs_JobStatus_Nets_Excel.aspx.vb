...
Partial Class Reports2_CustomerJobs_JobStatus_Nets_Excel
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If IsPostBack = "False" Then
            ...
            selectCMD1.Parameters.Add("@ShipToID", SqlDbType.NVarChar).Value = Request.QueryString("ShipToID").ToString()
            ...
            Dim xlsFileName As String = myReader("Custname") + "_" + myReader("JobName") + "_Nets_" + Now.Date.ToShortDateString() + ".xlsx"
            ...
            ReportViewer1.ServerReport.ReportPath = "/Customers/subJobNets"

            Dim pinfo As ReportParameterInfoCollection
            Dim paramlist As New Generic.List(Of ReportParameter)

            paramlist.Add(New ReportParameter("CustID", Request.QueryString("CustID").ToString(), False))
            paramlist.Add(New ReportParameter("ShipToID", Request.QueryString("ShipToID").ToString(), False))

<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/Operations_Secure.master" AutoEventWireup="false" CodeFile="News_Future.aspx.vb" Inherits="Operations_Secure_News_Future" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContentPlaceHolder" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" Runat="Server">

<h1>Operations| Future News</h1>
 ...
 <div id="News" style="padding:2px 5px 2px 5px; width:95%; height:75%;">   
     <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" >
         <Tabs>
             ...
             <telerik:RadTab runat="server" Text="Sales" Value="Sales"></telerik:RadTab>
             <telerik:RadTab runat="server" Text="Warehouse" Value="Warehouse"></telerik:RadTab>
         </Tabs>
     </telerik:RadTabStrip>

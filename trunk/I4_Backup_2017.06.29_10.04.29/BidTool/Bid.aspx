        ...
        <AjaxSettings>
           ...
           <telerik:AjaxSetting AjaxControlID="grdSub">
            ...
            <telerik:AjaxSetting AjaxControlID="btnTakeOffRelatedSEarch">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="listBoxTakeOffQuicklistRelated2" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting> 
            
            <telerik:AjaxSetting AjaxControlID="listBoxTakeOffQuicklistRelated2">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="listBoxTakeOffQuicklistRelated2" />
                    <telerik:AjaxUpdatedControl ControlID="grdSubsectionDetail" />
                    <telerik:AjaxUpdatedControl ControlID="lineUpdateDetailIDIndex" />
                    <telerik:AjaxUpdatedControl ControlID="listBoxTakeOffGrabList2" />
                    <telerik:AjaxUpdatedControl ControlID="lineUpdateLineNew" />
                                        ...
                                        <div id="divTakeOffLineItems" style="float: left; width:700px; margin-right:10px; ">
                                            <h6>Line Items</h6>
                                                ...
                                                <div style="width:100%; margin:3px 3px 3px 3px; ">  
                                                      <telerik:RadGrid ID="grdSubsectionDetail" runat="server" DataSourceID="SqlDS_grdSubsectionDetail" AllowMultiRowEdit="True"
                                                            width="700px" Height="530px" AllowSorting="True" Font-Size="Small" GroupPanelPosition="Top" ResolvedRenderMode="Classic"  >
                                                                 ...
                                                                 <BatchEditingSettings EditType="Cell" OpenEditingEvent="Click" />
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <telerik:GridTemplateColumn HeaderText="Qty" SortExpression="Qty" UniqueName="TemplateColumn" DataField="Qty">
                                                                            ...
                                                                            <EditItemTemplate>
                                                                                <span>
                                                                                    <telerik:RadNumericTextBox Width="50px" runat="server" ID="txtBoxQtyUpdate2" MinValue="0" AutoCompleteType="Disabled" Font-Size="Small">
                                                                                    </telerik:RadNumericTextBox>                               
                                                                                </span>
                                                                            </EditItemTemplate>
                                                                        </telerik:GridTemplateColumn>

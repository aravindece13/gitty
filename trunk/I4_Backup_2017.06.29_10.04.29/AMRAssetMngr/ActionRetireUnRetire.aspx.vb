...
Partial Class AMRAssetMngr_ActionRetireUnRetire
    Inherits System.Web.UI.Page

    Protected Sub btnRetireUnRetire_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRetireUnRetire.Click
        If status.Text = "Retired" Then
            action.Value = "Retired"
        Else
            action.Value = "Unretired"
        End If
        ...
        updateSQL &= "status=@status, notes=@notes "
        updateSQL &= "WHERE id=@id"

        Dim insertSQL As String
        insertSQL = "INSERT INTO aAsset_Hist ("
        insertSQL &= "id, name, status, "
        ...
        insertCmd.Parameters.AddWithValue("@status", Status.SelectedValue)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            selectSQL = "SELECT id, name, description, status, notes,assettag FROM aAsset WHERE id=" & Request.QueryString("id")

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/Exec.master" AutoEventWireup="false" CodeFile="AMR.aspx.vb" Inherits="Exec_AMR" %>
...
<h1>Executive | AMI Account Tracking</h1>
...
<telerik:RadMultiPage ID="RadMultiPage1" runat="server" Height="570px" Width="1000px">
  ...
  <telerik:RadPageView ID="Customers" runat="server" Selected="true">         
     ...
     <div id="divCustSearch" style="padding:0px 5px 5px 5px;float:left;width:995px;">                                      
         ...
         <telerik:RadGrid ID="RadGridCustSearch" runat="server" Width="1000px" Height="200px" 
                     AllowFilteringByColumn="True" AllowPaging="True" PageSize="50" AllowSorting="True" 
             ...
             <MasterTableView AutoGenerateColumns="False" DataKeyNames="CUSTKEY, CustID" DataSourceID="SqlDS_CustSearch" >
                ...
                <HeaderStyle VerticalAlign="Bottom" HorizontalAlign="Left" Font-Bold="true" /> 
                 ...
                 <Columns>
                     ...
                     <ItemStyle HorizontalAlign="Left" Width="100px" Font-Size="X-Small" />
                     </telerik:GridBoundColumn>
                     ...
                     <ItemStyle  HorizontalAlign="Left" Width="75px" Font-Size="X-Small" />
                     ...
                     <ItemStyle  HorizontalAlign="Left" Width="60px" Font-Size="X-Small" />
                     </telerik:GridBoundColumn>
    ...
    <telerik:RadTabStrip ID="RadTabStrip2" runat="server" MultiPageID="RadMultiPage2"  
        ...
        <telerik:RadMultiPage ID="RadMultiPage2" runat="server" Height="300px" Width="1000px" SelectedIndex="0">
            ...
            <telerik:RadPageView ID="CustProfile" runat="server" Selected="true"
                    BorderColor="SteelBlue" BorderWidth="1px" Height="300px" Width="1000px">
  ...
  <telerik:RadPageView ID="AddCustomer" runat="server" Selected="false">
    ...
    <telerik:RadPageView ID="Reports" runat="server" Height="570px" Width="1000px">
       <div id="divReportsPageView" style="padding:15px 5px 5px 15px;float:left;width:995px;">
           ...
           <asp:HyperLink ID="HyperLink1" Target="_blank" NavigateUrl="../Reports/AcctTrack/AcctTrack_RV_Overview_Executive.aspx" runat="server">
           <h6>AMR/AMI Specialist Overview</h6></asp:HyperLink>
            ...
            <asp:HyperLink ID="HyperLink3" Target="_blank" NavigateUrl="../Reports/AcctTrack/AcctTrack_RV_TaskMngment_Executive.aspx" runat="server">
            ...
            <asp:HyperLink ID="HyperLink4" Target="_blank" NavigateUrl="../Reports/AcctTrack/AcctTrack_RV_Sales_Executive.aspx" runat="server">
            ...
            <asp:HyperLink ID="HyperLink2" Target="_blank" NavigateUrl="../Reports/AcctTrack/AcctTrack_RV_Forecast_Executive.aspx" runat="server">
            ...
            <asp:HyperLink ID="HyperLink5" Target="_blank" NavigateUrl="../Reports/AcctTrack/AcctTrack_RV_AppActivity_Executive.aspx" runat="server">
 ...
 <telerik:RadWindowManager ID="Singleton" Skin="Silk" Width="1100" Height="600"

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/Sales.master" AutoEventWireup="false" CodeFile="Orders.aspx.vb" Inherits="Sales_Orders" %>
            ...
            <telerik:RadPageView ID="Headers" runat="server" Selected="true">
                     <div style="width:1700px; height:40px; Margin:10px 0px 0px 0px;">
                      ...
                      <div style="height:300px; width:1750px;">
                         ...
                         <asp:SqlDataSource ID="SqlDS_grdOrderHeaders" runat="server" ConnectionString="<%$ ConnectionStrings:DKConnectionString %>" SelectCommand="uspOrdersHeaderActiveGetAllSalesIDFilter" SelectCommandType="StoredProcedure">
                             <SelectParameters>
            ...
            <telerik:RadPageView ID="Lines" runat="server" Width="1300px" >
                <div style="width:1700px; height:40px; Margin:10px 0px 0px 0px;">
                      ...
                      <div style="height:300px; width:1600px;">
                             ...
                             <MasterTableView AutoGenerateColumns="False" DataKeyNames="OrderNumber" DataSourceID="SqlDS_grdLines" Width="1800px" >
                                <Columns>
                                     ...
                                     <telerik:GridBoundColumn DataField="Description" HeaderText="Description" ReadOnly="True" SortExpression="Description" UniqueName="Description">
                                        ...
                                        <ItemStyle HorizontalAlign="Left" Width="325px" VerticalAlign="Top" />
                                     </telerik:GridBoundColumn>
                         ...
                         <asp:SqlDataSource ID="SqlDS_grdLines" runat="server" ConnectionString="<%$ ConnectionStrings:DKConnectionString %>" SelectCommand="uspOrdersLinesActiveGetAllSalesIDFilter" SelectCommandType="StoredProcedure">
                             <SelectParameters>   
                                <asp:CookieParameter CookieName="SalesID1" DefaultValue="0" Name="SalesID1" Type="String" />
                                <asp:CookieParameter CookieName="SalesID2" DefaultValue="0" Name="SalesID2" Type="String" />
                                <asp:CookieParameter CookieName="SalesID3" DefaultValue="0" Name="SalesID3" Type="String" />

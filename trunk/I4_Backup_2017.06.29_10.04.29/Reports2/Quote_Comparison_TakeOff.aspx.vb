...
Partial Class Reports2_Quote_Comparison_TakeOff
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            Dim selectCMD1 As SqlCommand = New SqlCommand("uspProjectDetailGet", DKConnection1)
            selectCMD1.CommandType = CommandType.StoredProcedure
            selectCMD1.Parameters.Add("@JobID", SqlDbType.BigInt).Value = Request.QueryString("JobID").ToString()
            ...
            Dim pdfFileName As String = "TakeOff_Comparison_" + myReader("ProjectName") + "_" + myReader("ProjectSubtitle") + ".pdf"
            ...
            paramlist.Add(New ReportParameter("JobID", Request.QueryString("JobID").ToString(), False))

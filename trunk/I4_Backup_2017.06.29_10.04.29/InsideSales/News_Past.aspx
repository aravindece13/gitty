<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/InsideSales.master" AutoEventWireup="false" CodeFile="News_Past.aspx.vb" Inherits="InsideSales_News_Past" %>
...
<h1>Inside Sales | Past News</h1>

<div id="News" style="padding:0px 2px 2px 5px;float:left;height:600px;width:700px;">
    <asp:Panel ID="Panel1" runat="server" Width="100%" Height="100%" 
            ScrollBars="Vertical" BorderColor="#53b3e8" BorderStyle="Solid" BorderWidth="1px">
         
        
    <telerik:RadListView ID="RadListView1" runat="server" 
            DataSourceID="SqlDataSourceNews" width="100%" Height="100%">
     ...
     <asp:SqlDataSource ID="SqlDataSourceNews" runat="server" 
         ConnectionString="<%$ ConnectionStrings:InsiteConnectionString %>" 
            ...
            FROM aNews 
            WHERE Tags != 'Timesheets' AND (EndDate &lt; { fn NOW() }) AND (TopicArea IN ('Sales','Purchasing','AMR','Fleet','Payroll','Credit','Warehouse')) AND (DATEDIFF(dd, EndDate, { fn NOW() }) &lt; 180)

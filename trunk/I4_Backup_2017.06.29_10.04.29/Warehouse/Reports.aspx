<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/Warehouse.master" AutoEventWireup="false" CodeFile="Reports.aspx.vb" Inherits="Warehouse_Reports" %>
    ...
    <div id="divTabStrip1" style="margin:5px 5px 0px 5px;float:left;width:1000px;"> 
        <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1" Width="1000px" Skin="MetroTouch">
                <Tabs>
                    ...
                    <telerik:RadTab runat="server" Text="Orders" PageViewID="Orders" Selected="true"></telerik:RadTab>
                </Tabs>
        </telerik:RadTabStrip>
    </div>
    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server"  Width="1300px">
      ...
      <telerik:RadPageView ID="Inventory" runat="server" Selected="true">
                  ...
                  <div id="div5" style="margin:0px 0px 0px 0px;float:left;width:1300px;float:left;">
                     ...
                     <div style="width:1300px;">
	                     <div style="width:240px;float:left; margin:10px;">
                                <telerik:RadButton ID="RadButton33" ButtonType="LinkButton" runat="server" Width="200px" Skin="BlackMetroTouch" Text="Cycle Count Activity" NavigateUrl="../Reports2/Operations_CycleCounts_CycleCountWhse.aspx" Target="_blank"></telerik:RadButton>
        	             </div>
                  ...
                  <div id="div4" style="margin:0px 0px 0px 0px;float:left;width:1300px;float:left;">
                     ...
                     <div style="width:1300px;">
	                     <div style="width:240px;float:left; margin:10px;">
                                <telerik:RadButton ID="RadButton2" ButtonType="LinkButton" runat="server" Width="200px" Skin="BlackMetroTouch" Text="Cycle Count Supplemental" NavigateUrl="../Reports2/Operations_CycleCounts_CycleCount_Supplemental_live.aspx" Target="_blank"></telerik:RadButton>
        	             </div>
         	             <div style="width:700px; font-size:Small;float:left; margin-bottom:10px;">
     ...
     <telerik:RadPageView ID="Orders" runat="server" Selected="true">
         <div id="div3" style="margin:0px 0px 0px 0px;float:left;width:1300px;float:left;">
             <div style="width:1300px;">    
                  <div style="width:400px; padding:5px; margin: 10px 0px 10px 0px; color:White; background-color:#4c68a2; font-weight:bold; font-size:medium;">
                        Ready to Ship | Ship Via
                  </div>
             </div>
             <div style="width:1300px;">
	             <div style="width:260px;float:left; margin:10px;">
                        <telerik:RadButton ID="lnkShipVia" ButtonType="LinkButton" runat="server" Width="240px" Skin="BlackMetroTouch" Text="Ready to Ship | Ship Via" NavigateUrl="../Reports2/Orders_ShipVia.aspx" Target="_blank"></telerik:RadButton>
        	     </div>
         	     <div style="width:700px; font-size:Small;float:left; margin-bottom:10px;">
                       <b>Data Source: </b> <i>SXe (GUI) Live</i><br /><br /> 
                        <b>Report Description: </b>The Ship Via report is a listing of all open orders with quanities available to ship.  The requested mode of transportation (Ship Via) is available on each line item.<br /><br />

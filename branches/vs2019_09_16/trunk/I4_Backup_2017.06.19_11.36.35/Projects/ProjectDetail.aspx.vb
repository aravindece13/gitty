...
Partial Class Projects_ProjectDetail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = "false" Then
            ...
            SelectSQL1 = "SELECT [branchno],[state] FROM [dbo].[Branches] WHERE [branchno]= " + uPrimaryBranchno.SelectedValue.ToString()
            ...
            Try
                ...
                SqlDS_District.SelectParameters("State2").DefaultValue = myReader1("state").ToString()
            ...
            'Check the Job/Project record again to get the ID of the district and select it in the district dropdown box
            ...
            Dim selectCmd2 As SqlCommand = New SqlCommand("uspProjectDetailGet", DKConnection2)
            selectCmd2.CommandType = CommandType.StoredProcedure
            Dim Reader2 As SqlDataReader
            selectCmd2.Parameters.AddWithValue("JobID", Request("JobID").ToString())
            ...
            Try
                'Try to open the connection and execute the update
                DKConnection2.Open()
                Reader2 = selectCmd2.ExecuteReader()
                Reader2.Read()

                uDistrict.SelectedValue = Reader2("MuniSpecID")
    ...
    Protected Sub uPrimaryBranchno_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles uPrimaryBranchno.SelectedIndexChanged

  ...
  <telerik:RadMultiPage ID="RadMultiPage1" runat="server" Width="1800px">
        <telerik:RadPageView ID="Maintain" runat="server" Selected="true" >
                ...
                <div style="width:1800px; margin: 10px;">
                    ...
                    <div id="IntranetProfileListContainer" style="float:left;Margin:0px 20px 0px 0px; height:700px; width:500px;">
  
    
                        <telerik:RadGrid ID="RadGridProfiles" runat="server" DataSourceID="SqlDS_Profiles" GridLines="None" Height="650px" Width="500px" 
                            ...
                            <MasterTableView DataSourceID="SqlDS_Profiles" DataKeyNames="UserName" AutoGenerateColumns="False" Width="500px" >
                                <Columns>
        ...
        <telerik:RadPageView ID="Add" runat="server" >
            ...
            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="400px" Width="1800px" LoadingPanelID="LoadingPanel1">
                ...
                <div style="width:100%; Margin: 15px 0px 0px 10px; float:left;" >
                    <h3 style="Width:700px;">Warehouses</h3>
                    <div style="Margin:3px 0px 0px 10px;"> 
                      <telerik:RadComboBox ID="aWhse1" runat="server" Label="Whse 1:"  Width="100px" LabelCssClass="myLabelCss"  >
                            <Items>
                                <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />
                      ...
                      <telerik:RadComboBox ID="aWhse2" runat="server" Label="Whse 2:"  Width="100px" LabelCssClass="myLabelCss"  >
                            <Items>
                                <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />
                      ...
                      <telerik:RadComboBox ID="aWhse3" runat="server" Label="Whse 3:"  Width="100px" LabelCssClass="myLabelCss"  >
                                <Items>
                                    <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                    <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                    <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />
                      ...
                      <telerik:RadComboBox ID="aWhse4" runat="server" Label="Whse 4:"  Width="100px" LabelCssClass="myLabelCss"  >
                                    <Items>
                                        <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                        <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                        <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />
                      ...
                      <telerik:RadComboBox ID="aWhse5" runat="server" Label="Whse 5:"  Width="100px" LabelCssClass="myLabelCss"  >
                           <Items>
                                    <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                    <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                    <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />
                    ...
                    <div style="Margin:3px 0px 0px 10px;"> 
                      <telerik:RadComboBox ID="aWhse6" runat="server" Label="Whse 6:"  Width="100px" LabelCssClass="myLabelCss"  >
                            <Items>
                                <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />
                      ...
                      <telerik:RadComboBox ID="aWhse7" runat="server" Label="Whse 7:"  Width="100px" LabelCssClass="myLabelCss"  >
                            <Items>
                                <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />
                      ...
                      <telerik:RadComboBox ID="aWhse8" runat="server" Label="Whse 8:"  Width="100px" LabelCssClass="myLabelCss"  >
                                <Items>
                                    <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                    <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                    <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />
                      ...
                      <telerik:RadComboBox ID="aWhse9" runat="server" Label="Whse 9:"  Width="100px" LabelCssClass="myLabelCss"  >
                                    <Items>
                                        <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                        <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                        <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />
                      ...
                      <telerik:RadComboBox ID="aWhse10" runat="server" Label="Whse 10:"  Width="100px" LabelCssClass="myLabelCss"  >
                           <Items>
                                    <telerik:RadComboBoxItem runat="server" Text="-" Value="0" />
                                    <telerik:RadComboBoxItem runat="server" Text="01-Denver" Value="1" />
                                    <telerik:RadComboBoxItem runat="server" Text="02-Casper" Value="2" />

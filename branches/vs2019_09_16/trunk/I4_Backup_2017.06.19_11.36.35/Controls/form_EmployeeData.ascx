                        ...
                        <div style="width:900px; margin: 10px 0px 0px 10px;">
                            <div style="margin:0px 0px 2px 0px; width:900px; float:left;">  
                                ...
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    ...
                                    <telerik:RadDatePicker ID="pstartdt" runat="server" Width="120px" MinDate="1/1/1900" ></telerik:RadDatePicker>
                                </div>
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <asp:Label ID="Label5" runat="server" Text="Term Date:" cssclass="myLabelCss"></asp:Label>
                                    <telerik:RadDatePicker ID="ptermdt" runat="server" Width="120px" MinDate="1/1/1900" CssClass ="myLabelCss" ></telerik:RadDatePicker>
                                </div>
                            ...
                            <div style="margin:0px 0px 2px 0px; width:900px; float:left;">
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadTextBox ID="pname_first" runat="server" Label="First Name: " Wrap="false" Width="225px" LabelWidth="90px" MaxLength="15" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                                <div style="width:275px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadTextBox ID="pname_last" runat="server" Label="Last Name: " Width="225px" LabelWidth="90px" MaxLength="20" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                            </div>
               
                            <div style="margin:0px 0px 2px 0px; width:900px; float:left;">     
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadComboBox ID="pBranchno" Runat="server" Width="150px" Label="Branch:" LabelCssClass ="myLabelCss" >
                                                                                                                                                                                                                                                        <Items>
                                            <telerik:RadComboBoxItem runat="server" Text="1-Denver" Value="1" />
                                            <telerik:RadComboBoxItem runat="server" Text="2-Casper" Value="2" />
                                            <telerik:RadComboBoxItem runat="server" Text="3-CSprings" Value="3" />
                                ...
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadComboBox ID="pdept" Runat="server" Width="150px" Label="Department:" LabelCssClass ="myLabelCss" >
                                            <Items>                                                                                                                                              
                                                <telerik:RadComboBoxItem runat="server" Text="Accounting" Value="Accounting" />
                                                <telerik:RadComboBoxItem runat="server" Text="Administration" Value="Administration" />
                                                <telerik:RadComboBoxItem runat="server" Text="Branch Mngmnt" Value="Branch Mngmnt" />
                                ...
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadTextBox ID="pjobtitle" runat="server" Label="Title:" Width="200px" LabelWidth="40px" MaxLength="20" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                            </div>
          
                            <div style="margin:0px 0px 2px 0px; width:900px; float:left;">
                                 <div style="width:450px; height:30px; vertical-align:middle; float:left;">   
                                    <telerik:RadTextBox ID="pemail" runat="server" Label="eMail: " Width="275px" LabelWidth="90px" MaxLength="30" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                 </div>
                            </div>
          
                            <div style="margin:0px 0px 2px 0px; width:900px; float:left;">
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadTextBox ID="pmobile" runat="server" Label="Mobile:" Width="180px" LabelWidth="90px" MaxLength="50" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadTextBox ID="pfax" runat="server" Label="Fax:" Width="180px" LabelWidth="90px" MaxLength="15" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadTextBox ID="pextension" runat="server" Label="Extension:" LabelWidth="90px" Width="180px" MaxLength="5" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                            </div>
                            ...
                            <div style="margin:0px 0px 2px 0px; width:900px; float:left;">
                                <div style="width:600px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadTextBox ID="pstreet" runat="server" Label="Street: " Width="350px" LabelWidth="90px" MaxLength="40" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                            </div>  
 
                            <div style="margin:0px 0px 2px 0px; width:900px; float:left;">
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadTextBox ID="pcity" runat="server" Label="City: " Width="250px" LabelWidth="90px" MaxLength="20" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadComboBox ID="pState" Runat="server" Width="100px" Label="State:" LabelCssClass ="myLabelCss" >
                                        <Items>
                                            <telerik:RadComboBoxItem runat="server" Text="Arizona" Value="AZ" />
                                            <telerik:RadComboBoxItem runat="server" Text="Colorado" Value="CO" />
                                            <telerik:RadComboBoxItem runat="server" Text="Montana" Value="MT" />
                                ...
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">
                                    <telerik:RadTextBox ID="pzip" runat="server" Label="Zip:" Width="100px" LabelWidth="40px" MaxLength="11" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                            </div> 
            
                            <div style="margin:0px 0px 2px 0px; width:900px; float:left;">
                                 <div style="width:250px; height:30px; vertical-align:middle; float:left;">   
                                    <telerik:RadTextBox ID="phometele" runat="server" Label="Home Phone:" Width="180px" LabelWidth="90px" MaxLength="15" LabelCssClass ="myLabelCss"></telerik:RadTextBox>
                                </div>
                            </div>  
       
                            <div style="margin:0px 0px 2px 0px; width:900px; float:left;">
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">  
                                    <telerik:RadComboBox ID="pBday" Runat="server" Width="60px" Label="Birth Day:" LabelCssClass ="myLabelCss" >
                                        <Items>
                                            <telerik:RadComboBoxItem runat="server" Text="1" Value="1" />
                                            <telerik:RadComboBoxItem runat="server" Text="2" Value="2" />
                                            <telerik:RadComboBoxItem runat="server" Text="3" Value="3" />
                                ...
                                <div style="width:250px; height:30px; vertical-align:middle; float:left;">                    
                                    <telerik:RadComboBox ID="pBmonth" Runat="server" Width="100px" Label="Birth Month:" LabelCssClass ="myLabelCss" >
                                        <Items>
                                            <telerik:RadComboBoxItem runat="server" Text="January" Value="January" />
                                            <telerik:RadComboBoxItem runat="server" Text="February" Value="February" />
                                            <telerik:RadComboBoxItem runat="server" Text="March" Value="March" />
                           ...
                           <div style="margin:0px 0px 2px 0px; width:900px; float:left;">
                                    ...
                                    <telerik:RadTextBox ID="pnotes" runat="server" Label="Notes: " Width="500px" LabelWidth="90px" MaxLength="50" LabelCssClass ="myLabelCss"></telerik:RadTextBox>

<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/Accounting_Secure.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Accounting_Secure_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContentPlaceHolder" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" Runat="Server">

<h1>Accounting | News</h1>

    <div style="width:200px; height:20px; padding:2px 2px 2px 700px;">
        <a target="_self" href="News_Future.aspx">Future News</a> <b>&nbsp; | &nbsp;</b>
        <a target="_self" href="News_Past.aspx">Past News</a>
   </div> 

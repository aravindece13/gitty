   ...
   <div id="divTabStrip1" style="margin:0px 0px 0px 0px;float:left;width:1000px;">   
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server"  MultiPageID="RadMultiPage1" SelectedIndex="0"  Width="1000px" Skin="MetroTouch">
        <Tabs>
            ...
            <telerik:RadTab runat="server" Text="Benefits Summary" PageViewID="Summary" ></telerik:RadTab>
  ...
  <div style="margin:20px 0px 0px 0px;float:left; width:1000px; ">
        <telerik:RadMultiPage ID="RadMultiPage1" runat="server" Width="1000px">
          ...
          <telerik:RadPageView ID="Summary" runat="server" >
                <div id="div8" style="margin:15px 5px 5px 15px;float:left;width:1000px;">
                    <div style="width:100%;">
                        <div style="width:500px;float:left;">
                            <p>The Benefits Summary Handbook is a document produced each year to summarize the various benefits programs offered by Dana Kepner Company Inc. </p>
                        </div>
                    
                    </div>
                    <div style="margin:4px 4px 4px 4px;width:340px; float:left; " >
                          <telerik:RadButton ID="lnkBenefitsGuide" ButtonType="LinkButton" runat="server" Skin="BlackMetroTouch" Width="300px" Text="2017 Summary" NavigateUrl="~/HR/2017/2017_OpenEnrollment_Benefits Guide.pdf" Target="_blank"></telerik:RadButton>
                    </div>
                </div>
                <div id="div9" style="margin:15px 5px 5px 15px;float:left;width:1000px;">
                    <div style="width:100%;">
                        <div style="width:500px;float:left;">
                            <p>Lockton Company provides an overview of non-401(k) benefits each year.</p>
                        </div>
                    
                    </div>
                    <div style="margin:4px 4px 4px 4px;width:340px; float:left; " >
                          <telerik:RadButton ID="lnkEnrollmentPresentation" ButtonType="LinkButton" runat="server" Skin="BlackMetroTouch" Width="300px" Text="2017 Enrollment Presentation" NavigateUrl="~/HR/2017/2017_OpenEnrollment_Lockton.pdf" Target="_blank"></telerik:RadButton>
                    </div>
                </div>
          </telerik:RadPageView>
          ...
          <telerik:RadPageView ID="Health" runat="server" >
                ...
                <div id="div1" style="margin:15px 5px 55px 15px;float:left;width:1000px;">
                    <div style="margin:4px 4px 4px 4px;width:320px; float:left; " >
                        <telerik:RadButton ID="lnk2017BenefitsGuide" ButtonType="LinkButton" runat="server" Skin="BlackMetroTouch" Width="280px" Text="2017 Benefits Guide" NavigateUrl="~/HR/2017/2017_Dana_Kepner_Benefits_Guide V4.pdf" Target="_blank"></telerik:RadButton>
                    </div>
          ...
          <telerik:RadPageView ID="Audits" runat="server" >
                <div id="div5" style="margin:15px 5px 5px 15px;float:left;width:100px;">
                    ...
                    <div style="margin:4px 4px 4px 4px;width:1000px; float:left;" >
                        <telerik:RadButton ID="lnk2016HealthSummary" ButtonType="LinkButton" runat="server" Skin="BlackMetroTouch" Width="300px" Text="2016 Health Benefits - Summary Annual Report" NavigateUrl="~/HR/SummaryAnnualReport_Health_2016.pdf" Target="_blank"></telerik:RadButton>
                    </div>
                    <div style="margin:4px 4px 4px 4px;width:1000px; float:left;" >
            ...
            <div style="width:900px; height:500px; float:left; margin:5px 0px 10px 20px;">
                <telerik:RadMultiPage ID="RadMultiPage2" runat="server" Width="900px" 
                    ...
                    <telerik:RadPageView ID="Intro" runat="server" Width="800px" Height="1200px" BorderColor="#639AFF" BorderWidth="1px" BorderStyle="Solid" Selected="true"  >
                       ...
                       <p>
                            We have fifteen warehouse and distribution locations:
                       </p>
                            ...
                            <div style="width:775px; height:175px; margin:10px 0px 20px 20px;"> 
                             <div style="width:380px;float:left;">
                                ...
                                <div style="width:100%;">Branch #4 - Billings, Montana</div>
                             ...
                             <div style="width:380px;float:left;">
                                ...
                                <div style="width:100%;">Branch #12 - Lubbock, Texas*</div>

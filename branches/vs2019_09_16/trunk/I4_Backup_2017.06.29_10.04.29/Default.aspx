...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server" >
 ...
 <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="lnkRCI">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="lnkRCI" />
                </UpdatedControls>
            </telerik:AjaxSetting>
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" Height="120px"  Width="900px" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" SelectedIndex="3">
                       ...
                       <telerik:RadPageView ID="HR" runat="server"  > 
                                <div style="padding:4px 4px 4px 4px;width:160px; float:left; " >
                                      <telerik:RadButton ID="lnkRCI" ButtonType="LinkButton" runat="server" Width="130px" Text="RCI - Regional Care" NavigateUrl="http://www.regionalcare.com/" Skin="BlackMetroTouch" Font-Size="X-Small" Target="_blank"></telerik:RadButton>
                                </div>
                                <div style="padding:4px 4px 4px 4px;width:160px; float:left; " >
                      ...
                      <telerik:RadPageView ID="Inventory" runat="server" > 
                       ...
                       <telerik:RadPageView ID="IT" runat="server" > 
                                 ...
                                 <div style="padding:4px 4px 4px 4px;width:160px; float:left; " >
                                      <telerik:RadButton ID="lnkSecurityReq" ButtonType="LinkButton" runat="server" Width="130px" Text="Security Request" NavigateUrl="~/Information/Form_IS_SecurityAccess.pdf" Skin="BlackMetroTouch" Font-Size="X-Small" Target="_blank"></telerik:RadButton>
                                 </div>
                                 <div style="padding:4px 4px 4px 4px;width:160px; float:left; " >
                                      <telerik:RadButton ID="lnkSecurityAcc" ButtonType="LinkButton" runat="server" Width="130px" Text="Access Change" NavigateUrl="~/Information/Form_IS_AccessChange.pdf" Skin="BlackMetroTouch" Font-Size="X-Small" Target="_blank"></telerik:RadButton>
                                 </div>
                       ...
                       <telerik:RadPageView ID="Payroll" runat="server" Selected="true" > 
                             ...
                             <%--<div style="padding:4px 4px 4px 4px; width:160px; float:left;" >
                                  <telerik:RadButton ID="lnkTSHourly" ButtonType="LinkButton" runat="server" Width="130px" Text="Hourly Timesheet" NavigateUrl="~/Information/Kepner_NonExemptTimeSheet.xls" Skin="BlackMetroTouch" Font-Size="X-Small" Target="_blank"></telerik:RadButton>
                             </div> 
                             <div style="padding:4px 4px 4px 4px;width:160px; float:left; " >
                       ...
                       <telerik:RadPageView ID="Sales" runat="server" > 
                              ...
                              <div style="padding:4px 4px 4px 4px;width:160px; float:left;" >
                                  <telerik:RadButton ID="lnkExpenseReportInstructions" ButtonType="LinkButton" runat="server" Width="130px" Text="Expense Instructions" NavigateUrl="~/Information/Form_ExpenseReportInstructions.pdf" Skin="BlackMetroTouch" Font-Size="X-Small" Target="_blank"></telerik:RadButton>
                              </div>
                              <div style="padding:4px 4px 4px 4px; width:160px; float:left;" >

<%@ Page Title=""  Language="VB" MasterPageFile="~/MasterPages/Popups.master" AutoEventWireup="false" CodeFile="ActionRetireUnRetire.aspx.vb" Inherits="AMRAssetMngr_ActionRetireUnRetire" %>
...
//                GetRadWindow().BrowserWindow.refreshGrid(args);
  ...
  <div id="divFormView" style="padding: 5px 2px 5px 5px;">
    <h6>Retire / UnRetire an Asset</h6>
          ...
          <div style="padding: 10px 2px 5px 5px; width:500px; height:40px;">  
              ...
              <telerik:RadComboBox ID="Status" runat="server" Label="New Status: " Width="80px" >
                  <Items>
          ...
          <div style="padding: 10px 2px 5px 5px; width:500px; height:20px;">
              ...
              <asp:Button ID="btnRetireUnRetire" runat="server" Text="Update Status" />

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/Popups.master" AutoEventWireup="false" CodeFile="AP_DailyCosting.aspx.vb" Inherits="Reports2_AP_DailyCosting" %>
...
<div style="width:1150; height:800px; margin:15px;">    
   <h4>AP | Daily Costing</h4>
   <div style="width:1000px; font-size:small;float:left;">
        <b>Data Source: </b> <i>SXe (GUI) Live</i><br /><br /> 
        <b>Report Description: </b>The following is a listing of all costing transactions from the last 5 days.<br />

...
Partial Class Reports2_Operations_CycleCounts_CycleCountMaster
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            ReportViewer1.ServerReport.ReportPath = "/Operations/CycleCounts/CycleCountMaster"


            ReportViewer1.ServerReport.Refresh()

            'output as PDF
            Dim pdfFileName As String = "CycleCount14DayMaster_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".pdf"

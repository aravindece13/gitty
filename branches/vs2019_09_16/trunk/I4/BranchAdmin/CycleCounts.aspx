<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/BranchAdmin.master" AutoEventWireup="false" CodeFile="CycleCounts.aspx.vb" Inherits="BranchAdmin_CycleCounts" %>
...
<h1>Branch Admin | Cycle Counts</h1>
        ...
        <div style="width:780px; height:900px; float:left;" >
            ...
            <asp:SqlDataSource ID="SqlDS_grdLastOrders" runat="server" ConnectionString="<%$ ConnectionStrings:DKConnectionString %>" 
             ...
             <div style="width:660px; height:220px; float:left;">
                ...
                <telerik:RadGrid ID="grdLastPOs" runat="server" DataSourceID="SqlDS_grdLastPOs" AllowSorting="True" Height="180px" Width="450px"
                    AutoGenerateColumns="False" AllowPaging="false" GridLines="None" ShowFooter="false" >

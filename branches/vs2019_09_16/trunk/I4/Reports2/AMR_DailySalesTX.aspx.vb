...
Partial Class Reports2_AMR_DailySalesTX
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ServerReport.ReportPath = "/AMR/DailySalesTX"
        ...
        'output as PDF
        Dim pdfFileName As String = "AMR_DailySalesTX" + "_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".pdf"

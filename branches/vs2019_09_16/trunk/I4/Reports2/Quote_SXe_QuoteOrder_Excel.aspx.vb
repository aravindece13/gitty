...
Partial Class Reports2_Quote_SXe_QuoteOrder_Excel
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            Dim xlsFileName As String = myReader("Custname") + "_" + myReader("ProjectName") + "_" + myReader("ProjectSubtitle") + "_" + myReader("QuoteName") + ".xls"
            ...
            ReportViewer1.ServerReport.ReportPath = "/Quote/SXe_QuoteOrder"

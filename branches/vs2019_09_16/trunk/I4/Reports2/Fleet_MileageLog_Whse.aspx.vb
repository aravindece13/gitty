...
Partial Class Reports2_Fleet_MileageLog_Whse
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ServerReport.ReportPath = "/Fleet/WhseLogs"

        ReportViewer1.ProcessingMode = ProcessingMode.Remote

        Dim xlsFileName As String = "Fleet_WhseLogs_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".xlsx"

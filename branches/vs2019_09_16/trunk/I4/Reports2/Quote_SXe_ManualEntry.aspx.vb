...
Partial Class Reports2_Quote_SXe_ManualEntry
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            Dim pdfFileName As String = "SXe_StructEntryAid_" + myReader("Custname") + "_" + myReader("ProjectName") + "_" + myReader("QuoteName") + ".pdf"

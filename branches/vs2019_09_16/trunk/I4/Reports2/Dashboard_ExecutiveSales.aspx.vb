...
Partial Class Reports2_Dashboard_ExecutiveSales
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            Dim pdfFileName As String = "Sales Dashboard_Executive_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".pdf"
            ...
            ReportViewer1.ServerReport.ReportPath = "/Dashboards/Executive"

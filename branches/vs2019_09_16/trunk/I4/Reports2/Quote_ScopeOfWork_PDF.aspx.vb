...
Partial Class Reports2_Quote_ScopeOfWork_PDF
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            Dim pdfFileName As String = "SoW_" + myReader("Custname") + "_" + myReader("ProjectName") + "_" + myReader("ProjectSubtitle") + "_" + myReader("QuoteName") + ".pdf"
            ...
            ReportViewer1.ServerReport.ReportPath = "/Quote/ScopeOfWork_PDF"

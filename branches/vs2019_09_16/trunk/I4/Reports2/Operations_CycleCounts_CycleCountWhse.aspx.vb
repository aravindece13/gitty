...
Partial Class Reports2_Operations_CycleCounts_CycleCountWhse
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            ReportViewer1.ServerReport.ReportPath = "/Operations/CycleCounts/CycleCountWhse"
            ...
            'output as PDF
            Dim pdfFilename As String = "CycleCount_Activity_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".pdf"

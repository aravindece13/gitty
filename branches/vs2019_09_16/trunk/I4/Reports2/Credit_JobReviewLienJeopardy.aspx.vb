...
Partial Class Reports2_Credit_JobReviewLienJeopardy
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ServerReport.ReportPath = "/Credit/Credit_JobReviewLienJeopardy"


        ReportViewer1.ProcessingMode = ProcessingMode.Remote

        Dim xlsFileName As String = "JobReviewLienJeopardy_" + "_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".xlsx"

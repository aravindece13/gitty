...
Partial Class Reports2_Credit_JobReview
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ServerReport.ReportPath = "/Credit/Credit_JobReview"

        ReportViewer1.ProcessingMode = ProcessingMode.Remote

        Dim xlsFileName As String = "NewJobSetupReview_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".xlsx"

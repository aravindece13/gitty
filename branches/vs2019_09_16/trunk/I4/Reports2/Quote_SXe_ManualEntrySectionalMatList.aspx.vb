...
Partial Class Reports2_Quote_SXe_ManualEntrySectionalMatList
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            Dim pdfFileName As String = "SXe_EntryAid_SectionalMatList_" + myReader("Custname") + "_" + myReader("ProjectName") + "_" + myReader("QuoteName") + ".pdf"
            ...
            ReportViewer1.ServerReport.ReportPath = "/Quote/SXe_ManualEntrySectionalMatList"

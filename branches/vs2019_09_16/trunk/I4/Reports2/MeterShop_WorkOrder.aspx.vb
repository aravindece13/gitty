...
Partial Class Reports2_MeterShop_WorkOrder
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            Dim pdfFileName As String = "WorkOrderReport_" + "_" + Request.QueryString("WorkOrderID").ToString() + ".pdf"
            ...
            ReportViewer1.ServerReport.ReportPath = "/MeterShop/WorkOrderReport"

            Dim pinfo As ReportParameterInfoCollection
            Dim paramlist As New Generic.List(Of ReportParameter)

            paramlist.Add(New ReportParameter("WorkOrderID", Request.QueryString("WorkOrderID").ToString(), False))

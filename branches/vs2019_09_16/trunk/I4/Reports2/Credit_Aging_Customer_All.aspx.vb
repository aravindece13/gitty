...
Partial Class Reports2_Credit_Aging_Customer_All
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles ReportViewer1.Load
        ...
        ReportViewer1.ServerReport.ReportPath = "/Credit/Credit_Aging_Customer_All"


        ReportViewer1.ProcessingMode = ProcessingMode.Remote

        Dim xlsFileName As String = "Credit_Aging_Customer_All" + "_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".xlsx"

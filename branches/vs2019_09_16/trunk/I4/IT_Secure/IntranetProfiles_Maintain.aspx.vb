...
Partial Class IT_Secure_IntranetProfiles_Maintain
    ...
    Protected Sub RadGridProfiles_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadGridProfiles.SelectedIndexChanged
        ...
        If Page.IsPostBack Then
            ...
            Try
                ...
                uUserName.Text = Reader("UserName")
                uUserName2.Text = Reader("UserName2")
                uPayComID.Text = Reader("PayComID")
    ...
    Protected Sub btnUpdateProfile_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdateProfile.Click
        ...
        updateCMD.Parameters.AddWithValue("@UserName", uUserName.Text)
        updateCMD.Parameters.AddWithValue("@UserName2", uUserName2.Text)
        updateCMD.Parameters.AddWithValue("@PayComID", uPayComID.Text)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        insertCMD.Parameters.AddWithValue("@PayComID", aPayComID.Text)

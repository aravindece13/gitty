...
Partial Class MeterShop_WorkOrder
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            'Default values if a batch has not been created
            addSizeCode.Value = "02"
            addRate1.Value = 0
            addRate2.Value = 0
            addRate3.Value = 0
            addTestDate.Value = Now()
            lblAddFlowLow.Text = "0 GPM"
            lblAddFlowMed.Text = "0 GPM"
            lblAddFlowHi.Text = "0 GPM"
            ...
            Dim selectCMD2 As SqlCommand = New SqlCommand("uspMSGetBatchDetail", DKConnection2)

            selectCMD2.CommandType = CommandType.StoredProcedure
            selectCMD2.Parameters.Add("@WorkOrderID", SqlDbType.NVarChar).Value = hdnWorkOrderID.Value.ToString()
            selectCMD2.Parameters.Add("@BatchID", SqlDbType.NVarChar).Value = "00"
    ...
    Protected Sub btnAddBatch_Click(sender As Object, e As System.EventArgs) Handles btnAddBatch.Click
        ...
        'SelectSQL2 = "SELECT [SizeCode], [TestDate] FROM xMS_BatchList WHERE WorkOrderID = '" + hdnWorkOrderID.Value.ToString() + "' AND BatchID='00'"
        ...
        '    addSizeCode.Value = myReader2("SizeCode").ToString()
        '    addTestDate.Value = myReader2("TestDate")
        ...
        ' Redundant to code above.  Added to see if it clears some errors. Above code to be removed.
        Dim DKConnectionString2 As String = WebConfigurationManager.ConnectionStrings("DKConnectionString").ConnectionString
        Dim DKConnection2 As New SqlConnection(DKConnectionString2)
        Dim selectCMD2 As SqlCommand = New SqlCommand("uspMSGetBatchDetail", DKConnection2)
        ...
        selectCMD2.CommandType = CommandType.StoredProcedure
        selectCMD2.Parameters.Add("@WorkOrderID", SqlDbType.NVarChar).Value = hdnWorkOrderID.Value.ToString()
        selectCMD2.Parameters.Add("@BatchID", SqlDbType.NVarChar).Value = addBatchID.SelectedValue.ToString()
    ...
    Protected Sub addBatchID_PreRender(sender As Object, e As System.EventArgs) Handles addBatchID.PreRender
        ...
        If IsPostBack = "False" Then
            ...
            'Dim SelectSQL As String
            'SelectSQL = "SELECT [SizeCode], [TestDate] FROM xMS_BatchList WHERE WorkOrderID = '" + hdnWorkOrderID.Value.ToString() + "' AND BatchID='00'"

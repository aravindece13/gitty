<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/Popups.master" AutoEventWireup="false" CodeFile="AcctTrack_RV_Overview_AMRSpecialist.aspx.vb" Inherits="Reports_AcctTrack_RV_Overview_AMRSpecialist" %>
...
<h6>Reporting | AMR/AMI Specialist Overview</h6>
...
<div style="padding:5px 5px 5px 5px;">
     ...
     <telerik:ReportViewer ID="ReportViewer1" runat="server" Height="700px" Width="1000px" ParametersAreaVisible="true">
        <typereportsource typename="KepnerReporting.AcctTrack_Overview_AMRSpecialist, KepnerReporting, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null">
        </typereportsource>
    ...
    <%--<telerik:ReportViewer ID="ReportViewer1" runat="server" Width="1100px" 
        Height="700px"  
        Report="KepnerReporting.AcctTrack_Overview_AMRSpecialist, KepnerReporting, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null">
        <Resources ExportSelectFormatText="Export Format" />
    </telerik:ReportViewer>--%>

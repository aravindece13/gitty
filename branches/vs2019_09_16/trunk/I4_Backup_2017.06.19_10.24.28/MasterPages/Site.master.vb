...
Partial Class MasterPages_Site
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '    If IsDBNull(My.User.Name.ToString()) Then

        '        LabelUserName.Text = Request.Cookies("FullName").Value

        '        Response.Cookies("FullName").Value = "Guest"
        '        Response.Cookies("SalesName").Value = "Guest"
        '        Response.Cookies("Company").Value = "Dana Kepner Company"
        '        Response.Cookies("eMail").Value = ""
        '        Response.Cookies("Fax").Value = ""
        '        Response.Cookies("Mobile").Value = ""
        '        Response.Cookies("salesID1").Value = "0"
        '        Response.Cookies("salesID2").Value = "0"
        '        Response.Cookies("salesID3").Value = "0"
        '        Response.Cookies("salesID4").Value = "0"
        '        Response.Cookies("salesID5").Value = "0"

        '        Response.Cookies("Whse1").Value = "0"
        '        Response.Cookies("Whse2").Value = "0"
        '        Response.Cookies("Whse3").Value = "0"
        '        Response.Cookies("Whse4").Value = "0"
        '        Response.Cookies("Whse5").Value = "0"
        '        Response.Cookies("Whse6").Value = "0"
        '        Response.Cookies("Whse7").Value = "0"
        '        Response.Cookies("Whse8").Value = "0"
        '        Response.Cookies("Whse9").Value = "0"
        '        Response.Cookies("Whse10").Value = "0"


        '        Response.Cookies("Region1").Value = "0"
        '        Response.Cookies("Region2").Value = "0"
        '        Response.Cookies("Region3").Value = "0"
        '        Response.Cookies("Region4").Value = "0"
        '        Response.Cookies("Region5").Value = "0"
        '        Response.Cookies("Region6").Value = "0"
        '        Response.Cookies("Region7").Value = "0"
        '        Response.Cookies("Region8").Value = "0"

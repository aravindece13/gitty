...
Partial Class Controls_form_PricingModel_old
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Dim DKConnection25 As New SqlConnection(DKConnectionString24)
    ...
    Protected Sub btnUpdateRankVariance_Click(sender As Object, e As System.EventArgs) Handles btnUpdateRankVariance.Click
        ...
        updateCMD1.Parameters.Add("@PriceType", SqlDbType.NVarChar).Value = grdCategories.SelectedValues("ProdCatId").ToString()

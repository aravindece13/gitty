...
Partial Class Reports2_Pricing_ContractPricing_Job
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If IsPostBack = "False" Then
            ...
            Dim xlsFileName As String = myReader("Custname") + "_" + myReader("JobName") + "_Contracts_" + Now.Date.ToShortDateString() + ".xlsx"

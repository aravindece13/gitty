...
Partial Class Reports2_Quote_SXe_Contracts_Excel
    ...
    Protected Sub ReportViewer1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = "False" Then
            ...
            'Dim xlsFileName As String = myReader("Custname") + "_" + myReader("ProjectName") + "_" + myReader("ProjectSubtitle") + "_" + myReader("QuoteName") + "_" + FormatDateTime(Now(), Microsoft.VisualBasic.DateFormat.ShortDate).ToString() + ".xls"
            Dim xlsFileName As String = myReader("QuoteName") + "_" + Left(myReader("Custname"), 10) + "_" + Left(myReader("ProjectName"), 10) + "_" + myReader("ShipToID") + ".xls"
            ...
            ReportViewer1.ServerReport.ReportPath = "/Quote/SXe_Contracts"
